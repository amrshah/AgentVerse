...
const SupportBotPersonaSchema = z.object({
    ...
    welcomeMessage: z.string().describe("A welcome message that introduces the bot and gathers the initial user problem."),
...
2.  A welcome message that introduces the bot and immediately tries to understand the user's problem.
